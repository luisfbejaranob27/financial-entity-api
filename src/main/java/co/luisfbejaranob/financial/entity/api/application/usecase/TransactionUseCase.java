...
public class TransactionUseCase
{
    ...
    {
        Product originAccount;
        Product destinationAccount = null;

        if(transaction.getOriginAccount().equals(transaction.getDestinationAccount()))
        {
            originAccount = productRepository.findByAccountNumber(transaction.getOriginAccount());
        }
        else
        {
            originAccount = productRepository.findByAccountNumber(transaction.getOriginAccount());
            destinationAccount = productRepository.findByAccountNumber(transaction.getDestinationAccount());
        }
